...
public class Tutorial {
        public static void main(String[] args) {
                ...
                if (highTemperatureF <= 0) {
                        System.out.println("* Be sure to bundle up!");
                } else if (!isAboveFreezing) {
                        System.out.println("* You should probably wear a winter coat.");
                } else if (highTemperatureF < 65) {
                        System.out.println("* You should probably wear a light jacket.");
                }
                ...
                if(highTemperatureF - lowTemperatureF > 20) {
                        System.out.println("* Dress in layers today.");
                }
