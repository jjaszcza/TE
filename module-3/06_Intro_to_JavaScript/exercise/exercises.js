...
function cigarParty(cigars, isWeekend) {
	const minimumCount = 40;
	const maximumCount = 60;

	let hasMinAmount = cigars >= minimumCount;
	let maxAmountRange = (!isWeekend && cigars <= maximumCount) || isWeekend
	let goodParty = hasMinAmount && maxAmountRange;
