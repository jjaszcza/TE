<template>
  <div class="main">
    ...
    <a href="#" @click="showForm = true" v-if="showForm === false"
      >Add Review</a
    >

    <form v-on:submit.prevent="addReview" v-if="showForm === true">
      <div class="form-element">
        <label for="name">Name: </label>
        <input type="text" id="name" name="name" v-model="newReview.reviewer" />
      </div>
      <div class="form-element">
        <label for="title">Title: </label>
        <input type="text" id="title" name="title" v-model="newReview.title" />
      </div>
      <div class="form-element">
        <label for="rating">Rating</label>
        <select id="rating" name="rating" v-model.number="newReview.rating">
  ...
  computed: {
    ...
    filteredReviews() {
      return this.reviews.filter((r) =>
        this.filterRating === 0 ? true : r.rating === this.filterRating
      );
    },
  },
  methods: {
